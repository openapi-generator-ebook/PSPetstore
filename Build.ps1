...
$Manifest = @{
    ...
    Description = 'PSPetstore - the PowerShell module for Petstore'
    LicenseUri = 'https://mit-license.org/'

    ModuleVersion = '0.3.1'

    RootModule = 'PSPetstore.psm1'
    Guid = '{E0B03A2D-C9D1-4532-B03F-7C304397BC63}' # Has to be static, otherwise each new build will be considered different module
