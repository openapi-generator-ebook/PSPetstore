...
$Body = (Initialize-User -Id 123 -Username "Username_example" -FirstName "FirstName_example" -LastName "LastName_example" -Email "Email_example" -Password "Password_example" -Phone "Phone_example" -UserStatus 123) # User | Created user object

# Create user
try {
     $Result = New-User -Body $Body
} catch {
...
$Body = @((Initialize-User -Id 123 -Username "Username_example" -FirstName "FirstName_example" -LastName "LastName_example" -Email "Email_example" -Password "Password_example" -Phone "Phone_example" -UserStatus 123)) # User[] | List of user object

# Creates list of users with given input array
try {
     $Result = New-UsersWithArrayInput -Body $Body
} catch {
...
# Creates list of users with given input array
try {
     $Result = New-UsersWithListInput -Body $Body
} catch {
...
# Updated user
try {
     $Result = Update-User -Username $Username -Body $Body
} catch {
